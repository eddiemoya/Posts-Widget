 ...
 */    
class Question_list_Widget extends WP_Widget {
     ...
     * @var string [REQUIRED]
     */
    var $widget_name = 'Posts Widget: Question List';
     ...
     */
    var $id_base = 'question_list_widget';
     ...
     * @var string [OPTIONAL]
     */
    private $description = 'Question List Example';
     ...
     * @var string [OPTIONAL]
     */
    private $classname = 'question-list';
...
Question_List_Widget::register_widget();